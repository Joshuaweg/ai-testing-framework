...
from ai_test_framework.core.coverage import (
    Severity, CATCategory, FailureMode, ModeCoverage, CoverageReport,
...
__all__ = [
    ...
    "Severity", "CATCategory", "FailureMode", "ModeCoverage", "CoverageReport",
    "CoverageAnalyzer", "CoverageReporter", "CATALOGUE", "COVERAGE_MAP",
    "SurfaceFramingConsistencyTest", "RepeatedPromptConsistencyTest",
    "StatisticalConsistencyTest", "FramingVariant",
    "FormatContractTest", "FormatInstruction",
    "NUMERIC_INSTRUCTIONS", "YN_INSTRUCTIONS", "LETTER_INSTRUCTIONS",
    "WhatIfConsistencyTest", "InvariantExplanationTest", "CounterfactualValidityTest",
    "RationaleConsistencyTest", "ContrastiveExplanationTest",
    "DataProvenanceConsistencyTest", "OutputScopeConsistencyTest",
